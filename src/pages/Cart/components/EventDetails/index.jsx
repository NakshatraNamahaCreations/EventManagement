...
const EventDetails = ({ cartItems }) => {
  const [eventDetails, setEventDetails] = useState({
    ...
    address: null,
    // upload_invitation: "https://images.pexels.com/photos/1528851/pexels-photo-1528851.jpeg?cs=srgb&dl=pexels-alexfu-1528851.jpg&fm=jpg",
    // upload_gatepass: "https://images.pexels.com/photos/1528851/pexels-photo-1528851.jpeg?cs=srgb&dl=pexels-alexfu-1528851.jpg&fm=jpg",
  });
  ...
  const handleCheckout = async () => {
    ...
    formData.append("event_start_date", eventDetails.eventDate?.format("YYYY-MM-DD"));
    formData.append(
      "event_end_date",
    ...
    cartItems.forEach((item, index) => {
      formData.append(`product_data[${index}][orderId]`, `${Date.now()}${index}`);
      formData.append(`product_data[${index}][id]`, item.id || "undefined");
      formData.append(`product_data[${index}][productName]`, item.product_name || "Unknown");
      formData.append(`product_data[${index}][productPrice]`, item.product_price || 0);
      formData.append(
      ...
      formData.append(`product_data[${index}][sellerName]`, item.sellerName || "Unknown");
      formData.append(`product_data[${index}][sellerId]`, item.sellerId || "Unknown");
      formData.append(
    ...
    formData.append("user_name", "Suman");
    ...
    formData.append(
      "cart_total",
      cartItems.reduce((total, item) => total + (item.product_price || 0) * (item.quantity || 1), 0)
    );
